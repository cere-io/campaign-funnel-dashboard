...
export default function CommunityIntelligenceDashboard() {
  const [selectedOrganization, setSelectedOrganization] = useState<string>("2115");
  ...
  const startedToConnected = (
    (mockData.connectedCereWallet / mockData.startedDexSwap) *
    100
  ).toFixed(1);
  const startedToCompleted = (
    (mockData.completedTrade / mockData.startedDexSwap) *
    100
  ).toFixed(1);
  const connectedToCompleted = (
    (mockData.completedTrade / mockData.connectedCereWallet) *
    100
  ).toFixed(1);
  ...
  const sentimentScore = (
    (communityData.sentiment_analysis.positive_messages /
      (communityData.sentiment_analysis.positive_messages +
        communityData.sentiment_analysis.negative_messages)) *
    100
  ).toFixed(1);
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">
                  {communityData.sentiment_analysis.neutral_messages}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
        ...
        <Card className="border-0 shadow-lg">
          ...
          <CardContent>
            <div className="space-y-4">
              {communityData.assignments_summary
                ?.slice(0, 4)
